...
<body>
    ...
    <?php require_once("../controller/ControllerEditarCategory.php");?>
    <div class="row">
        <form method="post" action="../controller/ControllerEditarCategory.php" id="form" name="form"  class="col-10">
